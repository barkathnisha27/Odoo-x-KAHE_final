    ...
    <AppShell>
      ...
      <div className="p-6 lg:p-8 max-w-5xl mx-auto">
        <PageHeader icon={Tag} title="Coupons & Promotions" description="Create discount codes and promo offers"
          actions={<Button onClick={() => { setEditing({ id: "co" + Math.random().toString(36).slice(2, 7), code: "", discount_type: "percentage", discount_value: 10, active: true }); setOpen(true); }}><Plus className="w-4 h-4 mr-1.5" /> New Coupon</Button>}
        />
